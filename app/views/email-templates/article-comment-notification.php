<html>
    <body>
		...
		<div style="color: #465A65; margin-top: 20px;">
			<h4>Получихте коментар на Ваша новина от {{author_username}}!</h4>
			...
			<br>
			За да отговорите, отворете <a href="http://<?php echo Config::DOMAIN ?>/article/{{article_id}}" style="color: #F84241;">новината</a>.
		</div>
